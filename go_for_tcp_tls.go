...
func main() {
    crt, err := tls.LoadX509KeyPair("/Users/xuchangliang/object/sign/mqtt_server.crt", "/Users/xuchangliang/object/sign/mqtt_server.key")
    if err != nil {
    ...
    l, err := tls.Listen("tcp", ":8883", tlsConfig)
    if err != nil {
        log.Fatalln(err.Error())
    }
    for {
